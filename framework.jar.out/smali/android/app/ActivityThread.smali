...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/app/ActivityThread$ScreenShotData;,
...
.method static synthetic access$3100(Landroid/app/ActivityThread;Landroid/app/ActivityThread$ScreenShotData;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 131
    invoke-direct {p0, p1}, Landroid/app/ActivityThread;->handleCreateScreenShot(Landroid/app/ActivityThread$ScreenShotData;)V
...
.method private final handleCreateScreenShot(Landroid/app/ActivityThread$ScreenShotData;)V
    .locals 5
    .parameter "data"
    ...
    iget-object v4, p1, Landroid/app/ActivityThread$ScreenShotData;->token:Landroid/os/IBinder;
    ...
    iget-object v4, p1, Landroid/app/ActivityThread$ScreenShotData;->fd:Landroid/os/ParcelFileDescriptor;

    invoke-virtual {v3, v4}, Landroid/app/Activity;->onCreateUnlockScreenshot(Landroid/os/ParcelFileDescriptor;)I

    move-result v2

    .line 3633
    .local v2, ret:I
    iget-object v3, p1, Landroid/app/ActivityThread$ScreenShotData;->receiver:Landroid/app/IUnlockScreenShotReceiver;
    ...
    invoke-interface {v3, v4}, Landroid/app/IUnlockScreenShotReceiver;->finished(Landroid/content/ComponentName;)V
    ...
    invoke-interface {v3, v4}, Landroid/app/IUnlockScreenShotReceiver;->returnForTranslucent(Landroid/content/ComponentName;)V
    ...
    .line 3640
    :cond_2
    iget-object v3, v1, Landroid/app/ActivityThread$ActivityClientRecord;->activityInfo:Landroid/content/pm/ActivityInfo;
    ...
    invoke-interface {v3, v0}, Landroid/app/IUnlockScreenShotReceiver;->notFound(Ljava/lang/String;)V
    :try_end_0
...
.method private handleLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)V
    ...
    iget-object v5, p1, Landroid/app/ActivityThread$ActivityClientRecord;->profileFile:Ljava/lang/String;

    iget-object v6, p1, Landroid/app/ActivityThread$ActivityClientRecord;->profileFd:Landroid/os/ParcelFileDescriptor;

    invoke-virtual {v4, v5, v6}, Landroid/app/ActivityThread$Profiler;->setProfiler(Ljava/lang/String;Landroid/os/ParcelFileDescriptor;)V
    ...
    iget-boolean v5, p1, Landroid/app/ActivityThread$ActivityClientRecord;->autoStopProfiler:Z

    iput-boolean v5, v4, Landroid/app/ActivityThread$Profiler;->autoStopProfiler:Z
    ...
    iget-boolean v5, p1, Landroid/app/ActivityThread$ActivityClientRecord;->isForward:Z

    invoke-virtual {p0, v4, v7, v5}, Landroid/app/ActivityThread;->handleResumeActivity(Landroid/os/IBinder;ZZ)V

    .line 2143
    iget-object v4, p1, Landroid/app/ActivityThread$ActivityClientRecord;->activity:Landroid/app/Activity;

    iput-boolean v7, v4, Landroid/app/Activity;->mIsCreateForBack:Z
    ...
    invoke-virtual {v4}, Landroid/content/Intent;->getMeizuFlags()I
    ...
    invoke-interface {v4, v5, v6}, Landroid/app/IActivityManager;->moveActivityTaskToBack(Landroid/os/IBinder;Z)Z
    ...
    invoke-virtual {v4, v5}, Landroid/content/Intent;->setMeizuFlags(I)Landroid/content/Intent;
    :try_end_1
    ...
    .line 2210
    invoke-virtual {v0}, Landroid/app/Activity;->onLauncherWithBroughtToBack()V
...
.method getTopLevelResources(Ljava/lang/String;Landroid/app/LoadedApk;)Landroid/content/res/Resources;
    ...
    .prologue
    .line 1668
    iget-boolean v0, p2, Landroid/app/LoadedApk;->mNeedLoadTheme:Z

    .line 1669
    .local v0, needLoadTheme:Z
    iget-object v1, p2, Landroid/app/LoadedApk;->mCompatibilityInfo:Landroid/view/CompatibilityInfoHolder;

    invoke-virtual {v1}, Landroid/view/CompatibilityInfoHolder;->get()Landroid/content/res/CompatibilityInfo;

    move-result-object v1

    iget-object v2, p2, Landroid/app/LoadedApk;->mPackageName:Ljava/lang/String;

    invoke-virtual {p0, p1, v1, v2, v0}, Landroid/app/ActivityThread;->getTopLevelResources(Ljava/lang/String;Landroid/content/res/CompatibilityInfo;Ljava/lang/String;Z)Landroid/content/res/Resources;
...
.method getTopLevelResources(Ljava/lang/String;Landroid/content/res/CompatibilityInfo;Ljava/lang/String;Z)Landroid/content/res/Resources;
    .locals 9
    .parameter "resDir"
    .parameter "compInfo"
    .parameter "packageName"
    ...
    .line 1653
    invoke-virtual {v4, p3}, Landroid/content/res/Resources;->setThemeResource(Ljava/lang/String;)V
...
.method getTopLevelResources(Ljava/lang/String;Landroid/content/res/CompatibilityInfo;)Landroid/content/res/Resources;
    ...
    invoke-virtual {p0, p1, p2, v0, v1}, Landroid/app/ActivityThread;->getTopLevelResources(Ljava/lang/String;Landroid/content/res/CompatibilityInfo;Ljava/lang/String;Z)Landroid/content/res/Resources;
...
.method final handleResumeActivity(Landroid/os/IBinder;ZZ)V
    ...
    iget-boolean v3, v8, Landroid/content/pm/ApplicationInfo;->hideNavigationBar:Z

    .line 2676
    .local v3, hideNavigationBar:Z
    if-eqz v5, :cond_d
    ...
    :goto_0
    iget-boolean v8, v0, Landroid/app/Activity;->mStartedActivity:Z
    ...
    invoke-interface {v8, v9}, Landroid/app/IActivityManager;->willActivityBeVisible(Landroid/os/IBinder;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    iget-boolean v8, v0, Landroid/app/Activity;->mFinished:Z
    ...
    iput-object v8, v5, Landroid/app/ActivityThread$ActivityClientRecord;->window:Landroid/view/Window;
    ...
    sget-boolean v8, Landroid/os/Build;->MZ_USE_NAVBAR:Z
    ...
    .line 2716
    :cond_1
    iget-boolean v8, v0, Landroid/app/Activity;->mVisibleFromClient:Z
    ...
    .line 2718
    invoke-interface {v7, v1, v4}, Landroid/view/ViewManager;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-boolean v8, v5, Landroid/app/ActivityThread$ActivityClientRecord;->hideForNow:Z

    if-nez v8, :cond_6

    .line 2737
    iget-object v8, v5, Landroid/app/ActivityThread$ActivityClientRecord;->newConfig:Landroid/content/res/Configuration;
    ...
    invoke-static {v8, v9}, Landroid/app/ActivityThread;->performConfigurationChanged(Landroid/content/ComponentCallbacks2;Landroid/content/res/Configuration;)V

    .line 2741
    iget-object v8, v5, Landroid/app/ActivityThread$ActivityClientRecord;->activity:Landroid/app/Activity;

    iget-object v8, v8, Landroid/app/Activity;->mCurrentConfig:Landroid/content/res/Configuration;
    ...
    invoke-virtual {p0, v8}, Landroid/app/ActivityThread;->freeTextLayoutCachesIfNeeded(I)V
    ...
    .line 2764
    .restart local v7       #wm:Landroid/view/ViewManager;
    iget-object v8, v5, Landroid/app/ActivityThread$ActivityClientRecord;->window:Landroid/view/Window;
    ...
    invoke-interface {v7, v1, v4}, Landroid/view/ViewManager;->updateViewLayout(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iput-boolean v9, v8, Landroid/app/Activity;->mVisibleFromServer:Z
    ...
    iget-boolean v8, v8, Landroid/app/Activity;->mIsCreateForBack:Z
    ...
    .end local v4           #l:Landroid/view/WindowManager$LayoutParams;
    :cond_6
    iget-boolean v8, v5, Landroid/app/ActivityThread$ActivityClientRecord;->onlyLocalRequest:Z
    ...
    iput-object v8, v5, Landroid/app/ActivityThread$ActivityClientRecord;->nextIdle:Landroid/app/ActivityThread$ActivityClientRecord;
    ...
    invoke-direct {v9, p0, v10}, Landroid/app/ActivityThread$Idler;-><init>(Landroid/app/ActivityThread;Landroid/app/ActivityThread$1;)V
    ...
    iput-boolean v8, v5, Landroid/app/ActivityThread$ActivityClientRecord;->onlyLocalRequest:Z

    .line 2796
    .end local v0           #a:Landroid/app/Activity;
    .end local v2           #forwardBit:I
    .end local v6           #willBeVisible:Z
    :goto_6
    return-void
    ...
    .restart local v1       #decor:Landroid/view/View;
    .restart local v4       #l:Landroid/view/WindowManager$LayoutParams;
    .restart local v6       #willBeVisible:Z
    .restart local v7       #wm:Landroid/view/ViewManager;
    :cond_a
    const/4 v3, 0x0
    ...
    iput-boolean v8, v5, Landroid/app/ActivityThread$ActivityClientRecord;->hideForNow:Z
    ...
    invoke-interface {v8, p1, v9, v10}, Landroid/app/IActivityManager;->finishActivity(Landroid/os/IBinder;ILandroid/content/Intent;)Z
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
