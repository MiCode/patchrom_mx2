...
.method private checkContentPermission(Ljava/lang/String;Ljava/lang/String;)I
    .locals 11
    .parameter "pkgName"
    .parameter "pkgLabel"
    ...
    invoke-static {v7, p1, v8}, Landroid/provider/Settings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    .end local v3           #isOpen:I
    :cond_0
    :goto_0
    return v5

    .restart local v3       #isOpen:I
    :cond_1
    if-nez v3, :cond_2
    ...
    const-string v7, "android.intent.action.CHECK_APP"
    ...
    invoke-virtual {p0, v2}, Landroid/app/ContextImpl;->sendBroadcast(Landroid/content/Intent;)V
    ...
    invoke-static {v7, p1, v8}, Landroid/provider/Settings$Secure;->putInt(Landroid/content/ContentResolver;Ljava/lang/String;I)Z
    :try_end_2
    ...
    const-string v8, "checkContentPermission:  "
...
.method private checkLimitedPermission(Ljava/lang/String;III)I
    .locals 12
    ...
    .local v7, result:I
    :try_start_0
    sget-object v9, Landroid/os/Build;->MeizuSecurity:Ljava/lang/Boolean;
    ...
    invoke-direct {p0}, Landroid/app/ContextImpl;->getPhoneLimitedPermission()Ljava/util/ArrayList;
    ...
    invoke-virtual {v9, p3, p2, v10}, Landroid/content/pm/PackageManager;->getInstalledPackagesExtralPm(III)Ljava/util/List;
    ...
    .restart local v7       #result:I
    :cond_2
    invoke-direct {p0, v5, v4}, Landroid/app/ContextImpl;->checkContentPermission(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v11, "checkLimitedPermission: "
...
.method private getPhoneLimitedPermission()Ljava/util/ArrayList;
    ...
    .prologue
    iget-object v0, p0, Landroid/app/ContextImpl;->mPhoneLimitedPerList:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/app/ContextImpl;->mPhoneLimitedPerList:Ljava/util/ArrayList;
...
.method public checkInternalReadAndWriteContentPermission(Ljava/lang/String;II)I
    .locals 9
    .parameter "permission"
    .parameter "pid"
    .parameter "uid"
    ...
    invoke-virtual {v5, p3, p2, v8}, Landroid/content/pm/PackageManager;->getInstalledPackagesExtralPm(III)Ljava/util/List;
    ...
    .local v3, pkgLabel:Ljava/lang/String;
    ...
    :cond_2
    invoke-direct {p0, v4, v3}, Landroid/app/ContextImpl;->checkContentPermission(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .end local v3           #pkgLabel:Ljava/lang/String;
...
.method public checkPermission(Ljava/lang/String;II)I
    ...
    invoke-direct {p0, p1, p2, p3, v1}, Landroid/app/ContextImpl;->checkLimitedPermission(Ljava/lang/String;III)I
...
.method final init(Landroid/app/LoadedApk;Landroid/os/IBinder;Landroid/app/ActivityThread;Landroid/content/res/Resources;Ljava/lang/String;)V
    ...
    iget-boolean v3, v3, Landroid/app/LoadedApk;->mNeedLoadTheme:Z
