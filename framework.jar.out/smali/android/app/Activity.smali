...
.implements Landroid/view/Window$CallbackByMeizu;
...
.field private mLedRotation:I

.field private mLedSettingAutoCancel:Z
...
.field private mUpdateResumeLed:Ljava/lang/Runnable;
...
.method public constructor <init>()V
    ...
    .line 706
    iput-boolean v1, p0, Landroid/app/Activity;->mMenuOpened:Z

    .line 707
    iput v2, p0, Landroid/app/Activity;->mOrientation:I

    .line 708
    iput-boolean v2, p0, Landroid/app/Activity;->mIsMenuEnable:Z

    .line 709
    iput-boolean v1, p0, Landroid/app/Activity;->mMenuHasSet:Z

    .line 710
    iput-boolean v2, p0, Landroid/app/Activity;->mIsBackEnable:Z

    .line 711
    iput-boolean v1, p0, Landroid/app/Activity;->mBackHasSet:Z

    .line 712
    iput-boolean v1, p0, Landroid/app/Activity;->mLedSettingAutoCancel:Z

    .line 713
    iput-boolean v1, p0, Landroid/app/Activity;->mHasChecked:Z

    .line 714
    const/4 v0, -0x1

    iput v0, p0, Landroid/app/Activity;->mLedRotation:I

    .line 715
    iput-boolean v1, p0, Landroid/app/Activity;->mIsInActionMode:Z

    .line 717
    iput-boolean v1, p0, Landroid/app/Activity;->mIsHomeActivity:Z

    .line 730
    iput-object v3, p0, Landroid/app/Activity;->mDecor:Landroid/view/View;
    ...
    .line 734
    iput-object v3, p0, Landroid/app/Activity;->mActionBar:Lcom/android/internal/app/ActionBarImpl;
    ...
    .line 765
    iput-object v3, p0, Landroid/app/Activity;->mResultData:Landroid/content/Intent;
    ...
    .line 770
    iput-object v3, p0, Landroid/app/Activity;->mDefaultKeySsb:Landroid/text/SpannableStringBuilder;
    ...
    iput-object v0, p0, Landroid/app/Activity;->mUpdateResumeLed:Ljava/lang/Runnable;
...
.method static synthetic access$400(Landroid/app/Activity;)Z
    ...
    .prologue
    .line 650
    iget-boolean v0, p0, Landroid/app/Activity;->mMenuOpened:Z

    return v0
.end method

.method private cancelLedSetting()V
    .locals 1
    ...
    .line 5532
    :try_start_0
    iget-object v0, p0, Landroid/app/Activity;->mLedManager:Landroid/app/ILedLightsServiceManager;

    invoke-interface {v0}, Landroid/app/ILedLightsServiceManager;->cancelLastSetting()V
    :try_end_0
...
.method private checkMenu()V
    ...
    .line 5414
    :try_start_0
    iget-boolean v4, p0, Landroid/app/Activity;->mMenuHasSet:Z

    if-nez v4, :cond_0

    iget-boolean v4, p0, Landroid/app/Activity;->mHasChecked:Z
    ...
    iput-boolean v4, p0, Landroid/app/Activity;->mHasChecked:Z

    .line 5416
    const/4 v4, 0x0

    invoke-virtual {p0, v4}, Landroid/app/Activity;->onCreatePanelView(I)Landroid/view/View;
    ...
    iput-boolean v4, p0, Landroid/app/Activity;->mIsMenuEnable:Z
    ...
    invoke-direct {v2, p0}, Lcom/android/internal/view/menu/MenuBuilder;-><init>(Landroid/content/Context;)V

    .line 5422
    .local v2, menuBuilder:Lcom/android/internal/view/menu/MenuBuilder;
    invoke-virtual {p0, v2}, Landroid/app/Activity;->onCreateOptionsMenu(Landroid/view/Menu;)Z

    move-result v0

    .line 5423
    invoke-virtual {p0, v2}, Landroid/app/Activity;->onPrepareOptionsMenu(Landroid/view/Menu;)Z
    ...
    invoke-virtual {v2}, Lcom/android/internal/view/menu/MenuBuilder;->hasVisibleItems()Z
    ...
    .end local v2           #menuBuilder:Lcom/android/internal/view/menu/MenuBuilder;
    .end local v3           #prepare:Z
    :catch_0
    move-exception v1
    ...
    iget-object v6, p0, Landroid/app/Activity;->mIntent:Landroid/content/Intent;
    ...
    .restart local v2       #menuBuilder:Lcom/android/internal/view/menu/MenuBuilder;
    .restart local v3       #prepare:Z
    :cond_2
    const/4 v4, 0x0
...
.method private updateBackLed()V
    .locals 4
    ...
    .line 5469
    :try_start_0
    iget-boolean v2, p0, Landroid/app/Activity;->mBackHasSet:Z

    if-nez v2, :cond_4

    .line 5470
    iget-boolean v2, p0, Landroid/app/Activity;->mIsHomeActivity:Z

    if-eqz v2, :cond_2

    .line 5471
    iget-boolean v2, p0, Landroid/app/Activity;->mMenuOpened:Z

    if-nez v2, :cond_0

    .line 5472
    iget-object v2, p0, Landroid/app/Activity;->mLedManager:Landroid/app/ILedLightsServiceManager;

    iget-boolean v3, p0, Landroid/app/Activity;->mIsHomeActivity:Z

    if-nez v3, :cond_1

    :goto_0
    iget-boolean v1, p0, Landroid/app/Activity;->mLedSettingAutoCancel:Z

    invoke-interface {v2, v0, v1}, Landroid/app/ILedLightsServiceManager;->setBackEnable(ZZ)V
    ...
    iget-boolean v1, p0, Landroid/app/Activity;->mIsBackEnable:Z

    iget-boolean v2, p0, Landroid/app/Activity;->mLedSettingAutoCancel:Z

    invoke-interface {v0, v1, v2}, Landroid/app/ILedLightsServiceManager;->setBackEnable(ZZ)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private updateLedRotation(I)V
    .locals 1
    .parameter "rotation"
    ...
    invoke-interface {v0, p1}, Landroid/app/ILedLightsServiceManager;->setDisplayOrientation(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private updateMenuLed()V
    ...
    iget-boolean v1, p0, Landroid/app/Activity;->mIsMenuEnable:Z

    iget-boolean v2, p0, Landroid/app/Activity;->mLedSettingAutoCancel:Z

    invoke-interface {v0, v1, v2}, Landroid/app/ILedLightsServiceManager;->setMenuEnable(ZZ)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method final attach(Landroid/content/Context;Landroid/app/ActivityThread;Landroid/app/Instrumentation;Landroid/os/IBinder;ILandroid/app/Application;Landroid/content/Intent;Landroid/content/pm/ActivityInfo;Ljava/lang/CharSequence;Landroid/app/Activity;Ljava/lang/String;Landroid/app/Activity$NonConfigurationInstances;Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v1, p0}, Landroid/view/Window;->setCallbackByMeizu(Landroid/view/Window$CallbackByMeizu;)V
...
.method public isHomeActivity()Z
    ...
    .prologue
    .line 5538
    iget-boolean v0, p0, Landroid/app/Activity;->mIsHomeActivity:Z
...
.method public onActionModeFinished(Landroid/view/ActionMode;)V
    ...
    iput-boolean v0, p0, Landroid/app/Activity;->mIsInActionMode:Z

    .line 4948
    iget-boolean v0, p0, Landroid/app/Activity;->mIsMenuEnable:Z

    invoke-virtual {p0, v0}, Landroid/app/Activity;->setMenuEnabled(Z)V
...
.method public onActionModeStarted(Landroid/view/ActionMode;)V
    ...
    .line 4932
    :try_start_0
    iget-object v1, p0, Landroid/app/Activity;->mLedManager:Landroid/app/ILedLightsServiceManager;

    const/4 v2, 0x0

    iget-boolean v3, p0, Landroid/app/Activity;->mLedSettingAutoCancel:Z

    invoke-interface {v1, v2, v3}, Landroid/app/ILedLightsServiceManager;->setMenuEnable(ZZ)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v2, p0, Landroid/app/Activity;->mLedManager:Landroid/app/ILedLightsServiceManager;
    ...
    iput-object v2, p0, Landroid/app/Activity;->mDisplay:Landroid/view/Display;
    ...
    .line 915
    iput-boolean v4, p0, Landroid/app/Activity;->mIsHomeActivity:Z
    ...
    iput-boolean v2, p0, Landroid/app/Activity;->mIsHomeActivity:Z
...
.method protected onDestroy()V
    ...
    .line 1536
    iput-boolean v7, p0, Landroid/app/Activity;->mBackHasSet:Z

    .line 1537
    iput-boolean v7, p0, Landroid/app/Activity;->mMenuHasSet:Z
...
.method public onPanelClosed(ILandroid/view/Menu;)V
    ...
    .line 2689
    invoke-virtual {p0, v1}, Landroid/app/Activity;->setBackEnabled(Z)V
...
.method protected onPostResume()V
    ...
    invoke-virtual {v1}, Lcom/android/internal/app/ActionBarImpl;->resume()V
...
.method protected onResume()V
    ...
    invoke-virtual {v8, p0}, Landroid/app/Application;->dispatchActivityResumed(Landroid/app/Activity;)V
    ...
    iget-boolean v7, v7, Landroid/content/pm/ActivityInfo;->needAccessControl:Z
    ...
    .line 1159
    :cond_0
    iget-object v7, p0, Landroid/app/Activity;->acm:Landroid/content/pm/AccessControlManager;
    ...
    check-cast v7, Landroid/content/pm/AccessControlManager;

    iput-object v7, p0, Landroid/app/Activity;->acm:Landroid/content/pm/AccessControlManager;
    ...
    invoke-virtual {v7, v8}, Landroid/content/pm/AccessControlManager;->checkAccessControl(Ljava/lang/String;)Z
    ...
    invoke-virtual {v6, v7}, Landroid/content/Intent;->setAccessPackageName(Ljava/lang/String;)V
    ...
    invoke-virtual {v6, v7}, Landroid/content/Intent;->setAccessPackageLabel(Ljava/lang/String;)V
    ...
    invoke-virtual {v6, v7}, Landroid/content/Intent;->addMeizuFlags(I)Landroid/content/Intent;
...
.method protected onStop()V
    ...
    .line 1456
    invoke-direct {p0}, Landroid/app/Activity;->cancelLedSetting()V
    ...
    invoke-virtual {v1}, Landroid/content/Intent;->getMeizuFlags()I
    ...
    invoke-virtual {v1, v2}, Landroid/content/Intent;->setMeizuFlags(I)Landroid/content/Intent;
...
.method public setBackButtonDrawable(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 5565
    invoke-virtual {v0, p1, p2}, Landroid/app/ActionBar;->setBackButtonDrawable(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method public setBackEnabled(Z)V
    ...
    .line 5501
    iput-boolean p1, p0, Landroid/app/Activity;->mIsBackEnable:Z

    .line 5502
    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/app/Activity;->mBackHasSet:Z
    ...
    .line 5504
    invoke-direct {p0}, Landroid/app/Activity;->updateBackLed()V
...
.method public setLedRotation(I)V
    .locals 1
    .parameter "rotation"
    ...
    .line 5510
    iput p1, p0, Landroid/app/Activity;->mLedRotation:I

    .line 5511
    invoke-direct {p0, p1}, Landroid/app/Activity;->updateLedRotation(I)V
...
.method public setLedSettingAutoCancel(Z)V
    .locals 0
    .parameter "cancel"

    .prologue
    .line 5526
    iput-boolean p1, p0, Landroid/app/Activity;->mLedSettingAutoCancel:Z
...
.method public setMenuEnabled(Z)V
    ...
    .line 5492
    iput-boolean p1, p0, Landroid/app/Activity;->mIsMenuEnable:Z

    .line 5493
    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/app/Activity;->mMenuHasSet:Z
    ...
    .line 5495
    invoke-direct {p0}, Landroid/app/Activity;->updateMenuLed()V
...
.method public setMenuLedEnable(Z)V
    .locals 1
    .parameter "enable"

    .prologue
    .line 5551
    iget-boolean v0, p0, Landroid/app/Activity;->mMenuHasSet:Z
...
.method public updateLed()V
    ...
    iput-object v1, p0, Landroid/app/Activity;->mLedManager:Landroid/app/ILedLightsServiceManager;

    .line 5441
    :cond_0
    iget-object v1, p0, Landroid/app/Activity;->mDisplay:Landroid/view/Display;
    ...
    iput-object v1, p0, Landroid/app/Activity;->mDisplay:Landroid/view/Display;
    ...
    invoke-interface {v1, v2}, Landroid/app/ILedLightsServiceManager;->setTemporarySettingEnable(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 5452
    iget v1, p0, Landroid/app/Activity;->mLedRotation:I
    ...
    .local v0, rotation:I
    :goto_1
    invoke-direct {p0, v0}, Landroid/app/Activity;->updateLedRotation(I)V
    ...
    .line 5452
    :cond_3
    iget v0, p0, Landroid/app/Activity;->mLedRotation:I
