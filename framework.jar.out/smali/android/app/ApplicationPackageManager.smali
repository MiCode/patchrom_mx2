...
# static fields
.field private static final CALENDAR_PKG:Ljava/lang/String; = "com.android.calendar"

.field private static final DEBUG:Z = false

.field private static final DEBUG_ICONS:Z = false

.field private static final GALLERY_PKG:Ljava/lang/String; = "com.android.gallery3d"

.field private static final MAP_PKG:Ljava/lang/String; = "com.google.android.apps.maps"

.field private static final RESOURCES_PACKAGE:[Ljava/lang/String; = null

.field private static final RESOURCES_STRING:[Ljava/lang/String; = null
...
.method static constructor <clinit>()V
    ...
    const-string v1, "ic_launcher_gallery.png"

    aput-object v1, v0, v2

    const-string v1, "ic_launcher_video.png"
    ...
    sput-object v0, Landroid/app/ApplicationPackageManager;->RESOURCES_STRING:[Ljava/lang/String;
    ...
    const-string v1, "com.cooliris.video.media"
    ...
    sput-object v0, Landroid/app/ApplicationPackageManager;->RESOURCES_PACKAGE:[Ljava/lang/String;
...
.method public checkInternalReadAndWritePermission(Ljava/lang/String;Ljava/lang/String;)I
    .locals 3
    .parameter "permName"
    .parameter "pkgName"
    ...
    invoke-interface {v1, p1, p2}, Landroid/content/pm/IPackageManager;->checkInternalReadAndWritePermission(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getDrawable(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;
    ...
    sget-boolean v8, Landroid/content/res/theme/IconCustomHelper;->MEIZU_CALENDAI_ICON:Z
    ...
    :try_start_0
    invoke-virtual {p0, p1, v8}, Landroid/app/ApplicationPackageManager;->getApplicationInfo(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    :try_end_0
    ...
    .line 634
    invoke-static {}, Landroid/content/res/theme/IconCustomHelper;->getCalendarIcon()Landroid/graphics/drawable/Drawable;
    ...
    .line 642
    invoke-static {v5, v0}, Landroid/content/res/theme/IconCustomHelper;->makeThemeIcon(Landroid/content/res/Resources;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v5, p2, v6, v8}, Landroid/content/res/Resources;->getValue(ILandroid/util/TypedValue;Z)V
    ...
    .local v2, i:I
    :goto_2
    sget-object v8, Landroid/app/ApplicationPackageManager;->RESOURCES_STRING:[Ljava/lang/String;
    ...
    sget-object v9, Landroid/app/ApplicationPackageManager;->RESOURCES_STRING:[Ljava/lang/String;
    ...
    .line 652
    sget-object v8, Landroid/app/ApplicationPackageManager;->RESOURCES_PACKAGE:[Ljava/lang/String;
    ...
    :cond_5
    invoke-static {p1}, Landroid/content/res/theme/IconCustomHelper;->getCustomIcon(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    .restart local v4       #pName:Ljava/lang/String;
    ...
    iput-boolean v9, v8, Landroid/app/LoadedApk;->mNeedLoadTheme:Z
    ...
    .line 681
    :cond_9
    invoke-direct {p0, v3, v0}, Landroid/app/ApplicationPackageManager;->putCachedIcon(Landroid/app/ApplicationPackageManager$ResourceName;Landroid/graphics/drawable/Drawable;)V
    :try_end_1
    ...
    const-string v10, "Failure retrieving resources for"

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget-object v10, p3, Landroid/content/pm/PackageItemInfo;->packageName:Ljava/lang/String;
    ...
    const-string v10, "Failure retrieving icon 0x"
...
.method public getInstalledPackagesExtralPm(III)Ljava/util/List;
    .locals 3
    .parameter "uid"
    .parameter "pid"
    .parameter "flags"
    ...
    invoke-interface {v1, p1, p2, p3}, Landroid/content/pm/IPackageManager;->getInstalledPackagesExtralPm(III)Ljava/util/List;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
