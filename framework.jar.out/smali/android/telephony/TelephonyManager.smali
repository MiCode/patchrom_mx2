...
.method public listenEx(Lcom/meizu/internal/telephony/PhoneStateListenerEx;I)V
    .locals 2
    .parameter "listener"
    .parameter "events"
    ...
    invoke-virtual {p1}, Lcom/meizu/internal/telephony/PhoneStateListenerEx;->getCallback()Lcom/meizu/internal/telephony/IPhoneStateListenerEx;

    move-result-object v1

    invoke-interface {v0, v1, p2}, Lcom/android/internal/telephony/ITelephonyRegistry;->listenEx(Lcom/meizu/internal/telephony/IPhoneStateListenerEx;I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/NullPointerException; {:try_start_0 .. :try_end_0} :catch_0
