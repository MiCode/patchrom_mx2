...
.method public createMeizuRfcommRecord(Ljava/lang/String;Ljava/util/UUID;I)I
    .locals 5
    .parameter "name"
    .parameter "uuid"
    .parameter "channel"
    ...
    invoke-interface {v2, p1, v3, p3, v4}, Landroid/bluetooth/IBluetooth;->addRfcommServiceRecord(Ljava/lang/String;Landroid/os/ParcelUuid;ILandroid/os/IBinder;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "Not able to register SDP record for "
...
.method public enableFromWidget()Z
    .locals 3
    ...
    const-string v2, "enableFromWidget()..."
    ...
    invoke-interface {v1}, Landroid/bluetooth/IBluetooth;->enableFromWidget()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public enterTestMode()Z
    ...
    invoke-interface {v2}, Landroid/bluetooth/IBluetooth;->enterTestMode()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "enterTestMode result "
...
.method public enterWifiTestMode()Z
    ...
    invoke-interface {v2}, Landroid/bluetooth/IBluetooth;->enterWifiTestMode()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "enterWifiTestMode result "
...
.method public exitWifiTestMode()Z
    ...
    invoke-interface {v2}, Landroid/bluetooth/IBluetooth;->exitWifiTestMode()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "exitWifiTestMode result "
...
.method public getBondingDevices()Ljava/util/Set;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {v1}, Landroid/bluetooth/IBluetooth;->listBondings()[Ljava/lang/String;
