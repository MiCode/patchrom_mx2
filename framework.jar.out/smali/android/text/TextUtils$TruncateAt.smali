...
.field public static final enum MIDDLE_SMALL:Landroid/text/TextUtils$TruncateAt;

.field public static final enum START:Landroid/text/TextUtils$TruncateAt;

.field public static final enum START_SMALL:Landroid/text/TextUtils$TruncateAt;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "MIDDLE_SMALL"

    const/4 v2, 0x5

    invoke-direct {v0, v1, v2}, Landroid/text/TextUtils$TruncateAt;-><init>(Ljava/lang/String;I)V

    sput-object v0, Landroid/text/TextUtils$TruncateAt;->MIDDLE_SMALL:Landroid/text/TextUtils$TruncateAt;

    .line 1018
    new-instance v0, Landroid/text/TextUtils$TruncateAt;

    const-string v1, "START_SMALL"

    const/4 v2, 0x6

    invoke-direct {v0, v1, v2}, Landroid/text/TextUtils$TruncateAt;-><init>(Ljava/lang/String;I)V

    sput-object v0, Landroid/text/TextUtils$TruncateAt;->START_SMALL:Landroid/text/TextUtils$TruncateAt;
    ...
    sget-object v2, Landroid/text/TextUtils$TruncateAt;->MIDDLE_SMALL:Landroid/text/TextUtils$TruncateAt;

    aput-object v2, v0, v1

    const/4 v1, 0x6

    sget-object v2, Landroid/text/TextUtils$TruncateAt;->START_SMALL:Landroid/text/TextUtils$TruncateAt;
