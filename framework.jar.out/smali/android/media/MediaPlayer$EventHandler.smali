...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v4}, Landroid/media/MediaPlayer;->access$500(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnSeekCompleteListener;
    ...
    invoke-static {v4}, Landroid/media/MediaPlayer;->access$600(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnVideoSizeChangedListener;
    ...
    invoke-static {v4}, Landroid/media/MediaPlayer;->access$800(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnInfoListener;
    ...
    invoke-static {v4}, Landroid/media/MediaPlayer;->access$900(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$OnTimedTextListener;
    ...
    invoke-direct {v3, v1}, Landroid/media/TimedText;-><init>(Landroid/os/Parcel;)V
    :try_end_0
    ...
    .restart local v2       #text:Landroid/media/TimedText;
    :goto_1
    iget-object v4, p0, Landroid/media/MediaPlayer$EventHandler;->this$0:Landroid/media/MediaPlayer;
