...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/media/AudioManager$AudioLock;,
...
.field public static final ACTION_AUDIO_HEADSET_PLUG:Ljava/lang/String; = "android.media.audio.HEADSET_PLUG"
...
.field public static final FLAG_FORCE_TIMEOUT:I = 0x20
...
.method static synthetic access$300()Landroid/media/IAudioService;
    .locals 1
...
.method public closeEqualizer()I
    ...
    const-string v3, "Equalizer close"
    ...
    .local v1, service:Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1}, Landroid/media/IAudioService;->closeEqualizer()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in closeEqualizer"
...
.method public handleVolumePannel()V
    .locals 3
    ...
    invoke-virtual {p0, v1, v2, v0}, Landroid/media/AudioManager;->adjustSuggestedStreamVolume(III)V
...
.method public newAudioLock(Ljava/lang/String;)Landroid/media/AudioManager$AudioLock;
    .locals 1
    .parameter "tag"

    .prologue
    .line 2498
    new-instance v0, Landroid/media/AudioManager$AudioLock;

    invoke-direct {v0, p0, p1}, Landroid/media/AudioManager$AudioLock;-><init>(Landroid/media/AudioManager;Ljava/lang/String;)V
...
.method public openEqualizer()I
    ...
    const-string v3, "Equalizer open"
    ...
    .local v1, service:Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1}, Landroid/media/IAudioService;->openEqualizer()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in openEqualizer"
...
.method public setEqualizerBand([I)V
    ...
    const-string/jumbo v3, "set Equalizer band value"
    ...
    .local v1, service:Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1, p1}, Landroid/media/IAudioService;->setEqualizerBand([I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in setEqualizerBand"
...
.method public setEqualizerMode(I)V
    ...
    const-string/jumbo v3, "set Equalizer mode"
    ...
    .local v1, service:Landroid/media/IAudioService;
    :try_start_0
    invoke-interface {v1, p1}, Landroid/media/IAudioService;->setEqualizerMode(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Dead object in setEqualizerMode"
