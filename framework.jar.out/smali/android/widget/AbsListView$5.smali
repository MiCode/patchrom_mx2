...
.method constructor <init>(Landroid/widget/AbsListView;Landroid/view/View;ILandroid/widget/AbsListView$PerformClick;)V
    ...
    iput-object p2, p0, Landroid/widget/AbsListView$5;->val$child:Landroid/view/View;

    iput p3, p0, Landroid/widget/AbsListView$5;->val$motionPosition:I

    iput-object p4, p0, Landroid/widget/AbsListView$5;->val$performClick:Landroid/widget/AbsListView$PerformClick;
...
.method public run()V
    ...
    .line 3976
    iget-object v4, p0, Landroid/widget/AbsListView$5;->val$child:Landroid/view/View;
    ...
    iget v5, p0, Landroid/widget/AbsListView$5;->val$motionPosition:I
    ...
    invoke-static {v4, v5}, Landroid/widget/AbsListView;->access$1500(Landroid/widget/AbsListView;I)Z
    ...
    iget v7, p0, Landroid/widget/AbsListView$5;->val$motionPosition:I
    ...
    iget v4, p0, Landroid/widget/AbsListView$5;->val$motionPosition:I
    ...
    .line 3996
    :cond_3
    iget-object v3, p0, Landroid/widget/AbsListView$5;->val$performClick:Landroid/widget/AbsListView$PerformClick;
