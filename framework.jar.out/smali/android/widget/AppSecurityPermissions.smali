...
.method private getFilterPermissions()Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 533
    .local v0, finalList:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
...
.method public getSpecifiedPermissionPkg()Ljava/util/List;
    ...
    .prologue
    .line 508
    invoke-direct {p0}, Landroid/widget/AppSecurityPermissions;->getFilterPermissions()Ljava/util/List;
    ...
    .line 517
    .local v5, permSet:Ljava/util/Set;,"Ljava/util/Set<Landroid/content/pm/PermissionInfo;>;"
    iget-object v8, v6, Landroid/content/pm/PackageInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    invoke-direct {p0, v8, v5}, Landroid/widget/AppSecurityPermissions;->getAllUsedPermissions(ILjava/util/Set;)V
    ...
    const-string v10, "getPakcageInfo name="
    ...
    .line 529
    .end local v3           #i$:Ljava/util/Iterator;
    .end local v5           #permSet:Ljava/util/Set;,"Ljava/util/Set<Landroid/content/pm/PermissionInfo;>;"
