...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    .line 82
    new-instance v3, Landroid/net/sip/SipProfile;

    const/4 v4, 0x0

    invoke-direct {v3, v4}, Landroid/net/sip/SipProfile;-><init>(Landroid/net/sip/SipProfile$1;)V

    iput-object v3, p0, Landroid/net/sip/SipProfile$Builder;->mProfile:Landroid/net/sip/SipProfile;
    ...
    invoke-virtual {v3}, Ljavax/sip/SipFactory;->createAddressFactory()Ljavax/sip/address/AddressFactory;

    move-result-object v3

    iput-object v3, p0, Landroid/net/sip/SipProfile$Builder;->mAddressFactory:Ljavax/sip/address/AddressFactory;
    :try_end_0
    .catch Ljavax/sip/PeerUnavailableException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v4, "uriString cannot be null"
    ...
    .line 125
    .local v2, uri:Ljavax/sip/address/URI;
    instance-of v3, v2, Ljavax/sip/address/SipURI;
    ...
    .end local v2           #uri:Ljavax/sip/address/URI;
    ...
    invoke-static {v3, v4}, Landroid/net/sip/SipProfile;->access$502(Landroid/net/sip/SipProfile;Ljava/lang/String;)Ljava/lang/String;
    ...
    #setter for: Landroid/net/sip/SipProfile;->mPort:I
    invoke-static {v3, v1}, Landroid/net/sip/SipProfile;->access$402(Landroid/net/sip/SipProfile;I)I
    ...
    .line 128
    .end local v1           #port:I
    .restart local v2       #uri:Ljavax/sip/address/URI;
    :cond_2
    ...
    const-string v5, " is not a SIP URI"
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "serverDomain is null "
