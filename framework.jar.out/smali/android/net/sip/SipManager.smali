...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/net/sip/SipManager$SipServiceBinderListener;,
        Landroid/net/sip/SipManager$SipSessionListenerRelay;,
        Landroid/net/sip/SipManager$NotifyListenerRelay;,
        Landroid/net/sip/SipManager$ListenerRelay;,
        Landroid/net/sip/SipManager$SubListenerRelay;
    }
.end annotation
...
.field public static final INCOMING_FILE_TRANSFER_RESULT_CODE:I = 0x66
...
.method static synthetic access$002(Landroid/net/sip/SipManager;Landroid/net/sip/ISipService;)Landroid/net/sip/ISipService;
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 63
    iput-object p1, p0, Landroid/net/sip/SipManager;->mSipService:Landroid/net/sip/ISipService;

    return-object p1
.end method

.method static synthetic access$100(Landroid/net/sip/SipManager;)V
    .locals 0
    .parameter "x0"
...
.method private createNotifyRelay(Landroid/net/sip/SipNotifyListener;Ljava/lang/String;)Landroid/net/sip/ISipSessionListener;
    .locals 1
    .parameter "listener"
    .parameter "uriString"
    ...
    :cond_0
    new-instance v0, Landroid/net/sip/SipManager$NotifyListenerRelay;

    invoke-direct {v0, p1, p2}, Landroid/net/sip/SipManager$NotifyListenerRelay;-><init>(Landroid/net/sip/SipNotifyListener;Ljava/lang/String;)V
...
.method private createSipService()V
    ...
    iput-object v3, p0, Landroid/net/sip/SipManager;->mSipService:Landroid/net/sip/ISipService;
    ...
    .line 168
    const-string v3, "SipManager"

    const-string v4, "CreateSipService Fail!"
    ...
    .line 170
    :cond_0
    new-instance v2, Landroid/net/sip/SipManager$SipServiceBinderListener;

    iget-object v3, p0, Landroid/net/sip/SipManager;->mSipService:Landroid/net/sip/ISipService;

    invoke-interface {v3}, Landroid/net/sip/ISipService;->asBinder()Landroid/os/IBinder;

    move-result-object v3

    invoke-direct {v2, p0, v3}, Landroid/net/sip/SipManager$SipServiceBinderListener;-><init>(Landroid/net/sip/SipManager;Landroid/os/IBinder;)V

    .line 173
    .local v2, listener:Landroid/net/sip/SipManager$SipServiceBinderListener;
    :try_start_0
    iget-object v3, p0, Landroid/net/sip/SipManager;->mSipService:Landroid/net/sip/ISipService;
...
.method private createSipSessionRelay(Landroid/net/sip/SipSessionListener;Ljava/lang/String;)Landroid/net/sip/ISipSessionListener;
    .locals 1
    .parameter "listener"
    .parameter "uriString"
    ...
    :cond_0
    new-instance v0, Landroid/net/sip/SipManager$SipSessionListenerRelay;

    invoke-direct {v0, p1, p2}, Landroid/net/sip/SipManager$SipSessionListenerRelay;-><init>(Landroid/net/sip/SipSessionListener;Ljava/lang/String;)V

    goto :goto_0
.end method

.method private createSubscribeRelay(Landroid/net/sip/SipSubscribeListener;Ljava/lang/String;)Landroid/net/sip/ISipSessionListener;
    .locals 1
    .parameter "listener"
    .parameter "uriString"
    ...
    :cond_0
    new-instance v0, Landroid/net/sip/SipManager$SubListenerRelay;

    invoke-direct {v0, p1, p2}, Landroid/net/sip/SipManager$SubListenerRelay;-><init>(Landroid/net/sip/SipSubscribeListener;Ljava/lang/String;)V
...
.method public getMzRegisterProfile()Landroid/net/sip/SipProfile;
    ...
    invoke-interface {v2}, Landroid/net/sip/ISipService;->getMzRegisterProfile()Landroid/net/sip/SipProfile;
    ...
    .line 730
    const-string v2, "SipManager"

    const-string/jumbo v3, "sip service has not init!"
...
.method public sendMessage(Landroid/net/sip/SipProfile;Ljava/lang/String;Ljava/lang/String;ZLandroid/net/sip/SipSessionListener;)V
    .locals 4
    .parameter "localProfile"
    .parameter "smsNode"
    .parameter "smsUUID"
    ...
    invoke-direct {p0, p5, v3}, Landroid/net/sip/SipManager;->createSipSessionRelay(Landroid/net/sip/SipSessionListener;Ljava/lang/String;)Landroid/net/sip/ISipSessionListener;
    ...
    .line 641
    invoke-interface {v1, p2, p3, p4}, Landroid/net/sip/ISipSession;->message(Ljava/lang/String;Ljava/lang/String;Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setAutoRegisterAndNotify(Landroid/net/sip/SipProfile;Landroid/app/PendingIntent;Landroid/net/sip/SipSessionListener;)V
    .locals 3
    .parameter "localProfile"
    .parameter "incomingCallPendingIntent"
    .parameter "listener"
    ...
    invoke-direct {p0, p3, v2}, Landroid/net/sip/SipManager;->createSipSessionRelay(Landroid/net/sip/SipSessionListener;Ljava/lang/String;)Landroid/net/sip/ISipSessionListener;

    move-result-object v2

    invoke-interface {v1, p1, p2, v2}, Landroid/net/sip/ISipService;->openNotifySession(Landroid/net/sip/SipProfile;Landroid/app/PendingIntent;Landroid/net/sip/ISipSessionListener;)V
    ...
    const-string/jumbo v2, "sip service has not init!"
    ...
    const-string/jumbo v2, "setAutoRegisterAndNotify()"
...
.method public setNotifyListener(Ljava/lang/String;Landroid/net/sip/SipSessionListener;)V
    ...
    invoke-direct {p0, p2, p1}, Landroid/net/sip/SipManager;->createSipSessionRelay(Landroid/net/sip/SipSessionListener;Ljava/lang/String;)Landroid/net/sip/ISipSessionListener;

    move-result-object v2

    invoke-interface {v1, p1, v2}, Landroid/net/sip/ISipService;->setNotifyListener(Ljava/lang/String;Landroid/net/sip/ISipSessionListener;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v2, "setNotifyListener()"
...
.method public subscribe(Landroid/net/sip/SipProfile;ILjava/lang/String;Landroid/net/sip/SipSessionListener;)V
    .locals 4
    .parameter "localProfile"
    .parameter "expiryTime"
    .parameter "pushNode"
    ...
    invoke-direct {p0, p4, v3}, Landroid/net/sip/SipManager;->createSipSessionRelay(Landroid/net/sip/SipSessionListener;Ljava/lang/String;)Landroid/net/sip/ISipSessionListener;
    ...
    .line 630
    invoke-interface {v1, p2, p3}, Landroid/net/sip/ISipSession;->subscribe(ILjava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public subscribe(Landroid/net/sip/SipProfile;ILjava/lang/String;Landroid/net/sip/SipSubscribeListener;)V
    .locals 4
    .parameter "localProfile"
    .parameter "expiryTime"
    .parameter "pushNode"
    ...
    invoke-direct {p0, p4, v3}, Landroid/net/sip/SipManager;->createSubscribeRelay(Landroid/net/sip/SipSubscribeListener;Ljava/lang/String;)Landroid/net/sip/ISipSessionListener;
