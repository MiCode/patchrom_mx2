...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/net/DhcpStateMachine$RunDhcpThread;,
...
.method static synthetic access$2400(Landroid/net/DhcpStateMachine;)Landroid/net/DhcpInfoInternal;
    .locals 1
    .parameter "x0"

    .prologue
    .line 50
    iget-object v0, p0, Landroid/net/DhcpStateMachine;->mDhcpInfo:Landroid/net/DhcpInfoInternal;

    return-object v0
.end method

.method static synthetic access$2402(Landroid/net/DhcpStateMachine;Landroid/net/DhcpInfoInternal;)Landroid/net/DhcpInfoInternal;
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 50
    iput-object p1, p0, Landroid/net/DhcpStateMachine;->mDhcpInfo:Landroid/net/DhcpInfoInternal;
...
.method private runDhcp(Landroid/net/DhcpStateMachine$DhcpAction;)Z
    ...
    .line 397
    .local v1, success:Z
    new-instance v0, Landroid/net/DhcpStateMachine$RunDhcpThread;

    invoke-direct {v0, p0, p1}, Landroid/net/DhcpStateMachine$RunDhcpThread;-><init>(Landroid/net/DhcpStateMachine;Landroid/net/DhcpStateMachine$DhcpAction;)V

    .line 398
    .local v0, dhcpThread:Landroid/net/DhcpStateMachine$RunDhcpThread;
    invoke-virtual {v0}, Landroid/net/DhcpStateMachine$RunDhcpThread;->start()V

    .line 399
    const-string v2, "DhcpStateMachine"

    const-string/jumbo v3, "return sucess"
