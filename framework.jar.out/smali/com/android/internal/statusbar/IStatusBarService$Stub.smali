...
.field static final TRANSACTION_registerUndertableStarting:I = 0x14
...
.field static final TRANSACTION_setNavButtonVisible:I = 0x15

.field static final TRANSACTION_setSystemUiVisibility:I = 0xf

.field static final TRANSACTION_showStatusbarInFullScreen:I = 0x16
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-static {v1}, Landroid/app/IUndertableStartingManager$Stub;->asInterface(Landroid/os/IBinder;)Landroid/app/IUndertableStartingManager;

    move-result-object v2

    .line 274
    .local v2, _arg0:Landroid/app/IUndertableStartingManager;
    new-instance v14, Ljava/util/ArrayList;

    invoke-direct {v14}, Ljava/util/ArrayList;-><init>()V

    .line 276
    .local v14, _arg1:Ljava/util/List;,"Ljava/util/List<Landroid/os/IBinder;>;"
    new-instance v15, Ljava/util/ArrayList;

    invoke-direct {v15}, Ljava/util/ArrayList;-><init>()V

    .line 277
    .local v15, _arg2:Ljava/util/List;,"Ljava/util/List<Lcom/android/internal/statusbar/StatusBarNotification;>;"
    move-object/from16 v0, p0

    invoke-virtual {v0, v2, v14, v15}, Lcom/android/internal/statusbar/IStatusBarService$Stub;->registerUndertableStarting(Landroid/app/IUndertableStartingManager;Ljava/util/List;Ljava/util/List;)V
    ...
    .line 285
    .end local v2           #_arg0:Landroid/app/IUndertableStartingManager;
    .end local v14           #_arg1:Ljava/util/List;,"Ljava/util/List<Landroid/os/IBinder;>;"
    .end local v15           #_arg2:Ljava/util/List;,"Ljava/util/List<Lcom/android/internal/statusbar/StatusBarNotification;>;"
    :sswitch_15
    const-string v1, "com.android.internal.statusbar.IStatusBarService"
    ...
    invoke-virtual {v0, v2}, Lcom/android/internal/statusbar/IStatusBarService$Stub;->setNavButtonVisible(Z)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/internal/statusbar/IStatusBarService$Stub;->showStatusbarInFullScreen(Z)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/internal/statusbar/IStatusBarService$Stub;->updateStatusbarPos(Landroid/view/MotionEvent;)V
