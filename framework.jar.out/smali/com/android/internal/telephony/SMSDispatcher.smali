...
.field public static final RECEIVE_SMS_PERMISSION_SUPER:Ljava/lang/String; = "android.permission.RECEIVE_SMS_SUPER"
...
.method public static checkIsRequestSuperPermission()Z
    .locals 1
...
.method private notifyAndAcknowledgeLastIncomingSms(ZILandroid/os/Message;)V
    ...
    invoke-virtual {p0}, Lcom/android/internal/telephony/SMSDispatcher;->getReceiveSmsPermission()Ljava/lang/String;
...
.method protected dispatchNormalMessage(Lcom/android/internal/telephony/SmsMessageBase;)I
    ...
    invoke-virtual {v0, v11, v1, v2, v8}, Lcom/android/internal/telephony/WapPushOverSms;->dispatchWapPdu([[B[BLjava/lang/String;Ljava/lang/String;)I
...
.method public getReceiveSmsPermission()Ljava/lang/String;
    .locals 1
    ...
    const-string v0, "android.permission.RECEIVE_SMS_SUPER"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 253
    :pswitch_1
    iget-object v7, p0, Lcom/android/internal/telephony/SMSDispatcher;->mWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    invoke-direct {p0, v6, v7, v10}, Lcom/android/internal/telephony/SMSDispatcher;->notifyAndAcknowledgeLastIncomingSms(ZILandroid/os/Message;)V
...
.method protected handleSendComplete(Landroid/os/AsyncResult;)V
    ...
    .line 383
    const-string/jumbo v9, "message_ref"
    ...
    .line 382
    .restart local v4       #sendNext:Landroid/content/Intent;
    :cond_3
    const/4 v8, 0x0
...
.method protected processMessagePart([BLjava/lang/String;IIIJIZ)I
    ...
    .line 543
    .local v30, seqNumber:Ljava/lang/String;
    invoke-static/range {p5 .. p5}, Ljava/lang/Integer;->toString(I)Ljava/lang/String;

    move-result-object v23

    .line 546
    .local v23, msgCountStr:Ljava/lang/String;
    if-lez p4, :cond_0
    ...
    const-string v5, "Invalid long SMS from ["
    ...
    .end local v23           #msgCountStr:Ljava/lang/String;
    .end local v28           #pdus1:[[B
    .end local v29           #refNumber:Ljava/lang/String;
    .end local v30           #seqNumber:Ljava/lang/String;
    :goto_0
    ...
    .line 556
    .restart local v23       #msgCountStr:Ljava/lang/String;
    .restart local v29       #refNumber:Ljava/lang/String;
    .restart local v30       #seqNumber:Ljava/lang/String;
    :cond_2
    :try_start_1
    const-string v6, "address=? AND reference_number=? AND sequence=? AND count =?"
    ...
    .line 568
    .local v25, oldPduString:Ljava/lang/String;
    invoke-static/range {v25 .. v25}, Lcom/android/internal/util/HexDump;->hexStringToByteArray(Ljava/lang/String;)[B
    ...
    .line 575
    .restart local v28       #pdus1:[[B
    const/4 v3, 0x0

    aput-object v24, v28, v3
    ...
    .line 578
    .end local v24           #oldPdu:[B
    .end local v25           #oldPduString:Ljava/lang/String;
    .end local v28           #pdus1:[[B
    :cond_4
    move-object/from16 v0, p0
    ...
    .line 585
    const-string v11, "address=? AND reference_number=? AND count=?"
    ...
    sget-object v9, Lcom/android/internal/telephony/SMSDispatcher;->mRawUri:Landroid/net/Uri;

    sget-object v10, Lcom/android/internal/telephony/SMSDispatcher;->PDU_SEQUENCE_PORT_PROJECTION:[Ljava/lang/String;
    ...
    invoke-virtual {v3, v4, v11, v12}, Landroid/content/ContentResolver;->delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    :try_end_1
    ...
    .line 634
    .end local v6           #sqlwhere:Ljava/lang/String;
    .end local v7           #sqlwhereArgs:[Ljava/lang/String;
    .end local v11           #where:Ljava/lang/String;
    .end local v12           #whereArgs:[Ljava/lang/String;
    .end local v15           #cursorCount:I
    .end local v16           #cursorCount1:I
    .end local v21           #i:I
    .end local v23           #msgCountStr:Ljava/lang/String;
    .end local v29           #refNumber:Ljava/lang/String;
    .end local v30           #seqNumber:Ljava/lang/String;
    ...
    .line 649
    .restart local v6       #sqlwhere:Ljava/lang/String;
    .restart local v7       #sqlwhereArgs:[Ljava/lang/String;
    .restart local v11       #where:Ljava/lang/String;
    .restart local v12       #whereArgs:[Ljava/lang/String;
    .restart local v15       #cursorCount:I
    .restart local v16       #cursorCount1:I
    .restart local v21       #i:I
    .restart local v23       #msgCountStr:Ljava/lang/String;
    ...
    invoke-virtual {v3, v0, v1, v4, v2}, Lcom/android/internal/telephony/WapPushOverSms;->dispatchWapPdu([[B[BLjava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v3, v0, v4, v5, v2}, Lcom/android/internal/telephony/WapPushOverSms;->dispatchWapPdu([[B[BLjava/lang/String;Ljava/lang/String;)I
