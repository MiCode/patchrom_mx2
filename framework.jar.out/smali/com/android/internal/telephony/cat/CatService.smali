...
.field private static final ENABLE_STK_DELAY_TIME:I = 0xfa0

.field static final MSG_ID_CALL_SETUP:I = 0x4

.field private static final MSG_ID_ENABLE_STK:I = 0x1e
...
.field public static final STK_DEFAULT:Ljava/lang/String; = "Defualt Message"

.field private static cmdCnt:I

.field private static mIccRecords:Lcom/android/internal/telephony/IccRecords;

.field private static respCnt:I
...
.method static constructor <clinit>()V
    ...
    .line 102
    sput v1, Lcom/android/internal/telephony/cat/CatService;->cmdCnt:I

    .line 103
    sput v1, Lcom/android/internal/telephony/cat/CatService;->respCnt:I
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 613
    :sswitch_0
    sget v3, Lcom/android/internal/telephony/cat/CatService;->cmdCnt:I

    add-int/lit8 v3, v3, 0x1

    sput v3, Lcom/android/internal/telephony/cat/CatService;->cmdCnt:I
    ...
    const-string/jumbo v4, "ril message arrived, cnt1 = "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    sget v4, Lcom/android/internal/telephony/cat/CatService;->cmdCnt:I

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string v4, ", cnt2 = "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    sget v4, Lcom/android/internal/telephony/cat/CatService;->respCnt:I
    ...
    invoke-virtual {p0, v3}, Lcom/android/internal/telephony/cat/CatService;->obtainMessage(I)Landroid/os/Message;

    move-result-object v3

    const-wide/16 v4, 0xfa0

    invoke-virtual {p0, v3, v4, v5}, Lcom/android/internal/telephony/cat/CatService;->sendMessageDelayed(Landroid/os/Message;J)Z
    ...
    invoke-interface {v3, v4, v6}, Lcom/android/internal/telephony/CommandsInterface;->invokeOemRilRequestRaw([BLandroid/os/Message;)V
    ...
    .line 643
    :sswitch_5
    sget v3, Lcom/android/internal/telephony/cat/CatService;->respCnt:I

    add-int/lit8 v3, v3, 0x1

    sput v3, Lcom/android/internal/telephony/cat/CatService;->respCnt:I
    ...
    const-string/jumbo v4, "sendResponse, cnt1 = "
