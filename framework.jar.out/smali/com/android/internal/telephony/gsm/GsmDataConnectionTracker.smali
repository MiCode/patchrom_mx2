...
.field private static final NETWORK_CONNECT_FAIL_COUNT:I = 0x5
...
.method private broadcastNetWorkConnectFailIntent()V
    .locals 2
    ...
    const-string v1, "android.intent.action.NETWORK_CONNECT_FAIL"

    invoke-direct {v0, v1}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 1616
    .local v0, intent:Landroid/content/Intent;
    const-string v1, "Broadcasting intent android.intent.action.NETWORK_CONNECT_FAIL"
...
.method private reconnectAfterFail(Lcom/android/internal/telephony/DataConnection$FailCause;Lcom/android/internal/telephony/ApnContext;I)V
    ...
    const-string/jumbo v3, "reconnectAfterFail: lastFailCause="
    ...
    .line 1631
    .local v0, dconn:Lcom/android/internal/telephony/DataConnection;
    invoke-virtual {p2}, Lcom/android/internal/telephony/ApnContext;->getState()Lcom/android/internal/telephony/DataConnectionTracker$State;
    ...
    .line 1633
    invoke-virtual {v0}, Lcom/android/internal/telephony/DataConnection;->isRetryNeeded()Z
    ...
    .line 1640
    invoke-virtual {v0}, Lcom/android/internal/telephony/DataConnection;->retryForeverUsingLastTimeout()V

    .line 1653
    :cond_3
    invoke-virtual {v0}, Lcom/android/internal/telephony/DataConnection;->getRetryCount()I
    ...
    .line 1654
    invoke-direct {p0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->broadcastNetWorkConnectFailIntent()V
    ...
    const-string/jumbo v3, "reconnectAfterFail: increaseRetryCount="
    ...
    invoke-virtual {v3}, Lcom/android/internal/telephony/DataConnection;->getRetryCount()I
    ...
    const-string v3, " nextReconnectDelay="
    ...
    invoke-virtual {p2, v2}, Lcom/android/internal/telephony/ApnContext;->setRetryCount(I)V
...
.method protected onDisconnectDone(ILandroid/os/AsyncResult;)V
    ...
    const-string/jumbo v4, "onDisconnectDone: EVENT_DISCONNECT_DONE connId="
    ...
    .line 2197
    .local v1, apnContextDefault:Lcom/android/internal/telephony/ApnContext;
    invoke-virtual {v1, v2}, Lcom/android/internal/telephony/ApnContext;->setEnabled(Z)V
    ...
    invoke-virtual {p0, v2, v1}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    .line 2201
    const-string/jumbo v2, "onDisconnectDone: MMS disconnect,restore default apn.............."

    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->log(Ljava/lang/String;)V

    .line 2204
    .end local v1           #apnContextDefault:Lcom/android/internal/telephony/ApnContext;
    :cond_3
    invoke-virtual {v0, v6}, Lcom/android/internal/telephony/ApnContext;->setApnSetting(Lcom/android/internal/telephony/ApnSetting;)V
    ...
    .line 2198
    .restart local v1       #apnContextDefault:Lcom/android/internal/telephony/ApnContext;
    :cond_4
    const/4 v2, 0x0
...
.method protected onEnableApn(II)V
    ...
    const-string/jumbo v4, "onEnableApn("
    ...
    .line 1925
    .local v1, apnContextTmp:Lcom/android/internal/telephony/ApnContext;
    ...
    const-string/jumbo v6, "test cleanUpConnection: type:"
    ...
    .line 1928
    invoke-direct {p0, v1, v4, v3}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->applyNewState(Lcom/android/internal/telephony/ApnContext;ZZ)V

    goto :goto_1

    .line 1934
    .end local v1           #apnContextTmp:Lcom/android/internal/telephony/ApnContext;
    :cond_2
    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v6, "onEnableApn: apnContext="
    ...
    const-string v6, " call applyNewState"
    ...
    invoke-direct {p0, v0, v3, v4}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->applyNewState(Lcom/android/internal/telephony/ApnContext;ZZ)V
