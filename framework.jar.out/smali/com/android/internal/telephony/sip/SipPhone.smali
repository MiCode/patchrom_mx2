...
.method public clearDisconnected()V
    ...
    invoke-virtual {v1}, Lcom/android/internal/telephony/sip/SipPhone$SipCall;->clearDisconnectedEx()Z
...
.method dumpAddress(Ljavax/sip/address/Address;)V
    .locals 1
    .parameter "addr"

    .prologue
    .line 359
    invoke-interface {p1}, Ljavax/sip/address/Address;->getDisplayName()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/sip/SipPhone;->logHelper(Ljava/lang/Object;)V

    .line 360
    invoke-interface {p1}, Ljavax/sip/address/Address;->hasDisplayName()Z
    ...
    .line 361
    invoke-interface {p1}, Ljavax/sip/address/Address;->getHost()Ljava/lang/String;
    ...
    .line 362
    invoke-interface {p1}, Ljavax/sip/address/Address;->getPort()I
    ...
    .line 363
    invoke-interface {p1}, Ljavax/sip/address/Address;->getUserAtHostPort()Ljava/lang/String;
    ...
    .line 364
    invoke-interface {p1}, Ljavax/sip/address/Address;->isSIPAddress()Z
    ...
    .line 366
    invoke-interface {p1}, Ljavax/sip/address/Address;->isWildcard()Z
...
.method dumpSipProfile(Landroid/net/sip/SipProfile;)V
    .locals 2
    .parameter "callee"
    ...
    const-string v1, "dumpSipProfile"
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/sip/SipPhone;->dumpAddress(Ljavax/sip/address/Address;)V
...
.method logHelper(Ljava/lang/Object;)V
    .locals 3
    .parameter "str"
