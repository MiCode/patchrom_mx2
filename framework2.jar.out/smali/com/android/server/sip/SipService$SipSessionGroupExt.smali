...
.field private mNotifyListner:Landroid/net/sip/ISipSessionListener;
...
.method public constructor <init>(Lcom/android/server/sip/SipService;Landroid/net/sip/SipProfile;Landroid/app/PendingIntent;Landroid/net/sip/ISipSessionListener;)V
    ...
    .line 749
    iput-object v2, p0, Lcom/android/server/sip/SipService$SipSessionGroupExt;->mNotifyListner:Landroid/net/sip/ISipSessionListener;
    ...
    invoke-static {p1}, Lcom/android/server/sip/SipService;->access$300(Lcom/android/server/sip/SipService;)Lcom/android/server/sip/SipWakeupTimer;

    move-result-object v3

    #getter for: Lcom/android/server/sip/SipService;->mMyWakeLock:Lcom/android/server/sip/SipWakeLock;
    invoke-static {p1}, Lcom/android/server/sip/SipService;->access$400(Lcom/android/server/sip/SipService;)Lcom/android/server/sip/SipWakeLock;
...
.method public close()V
    ...
    const-string v1, "   mOpenedToReceiveCalls mSipGroup.close(); "
    ...
    const-string v1, "   close sipsession "
...
.method public onConnectivityChanged(Z)V
    ...
    invoke-static {v0, v1}, Lcom/android/server/sip/SipService;->access$702(Lcom/android/server/sip/SipService;I)I
    ...
    invoke-static {v0, v1}, Lcom/android/server/sip/SipService;->access$802(Lcom/android/server/sip/SipService;I)I
    ...
    .line 857
    :cond_0
    iget-object v0, p0, Lcom/android/server/sip/SipService$SipSessionGroupExt;->mNotifyListner:Landroid/net/sip/ISipSessionListener;

    invoke-virtual {p0, v0}, Lcom/android/server/sip/SipService$SipSessionGroupExt;->openToReceiveNotify(Landroid/net/sip/ISipSessionListener;)V
...
.method public onRinging(Landroid/net/sip/ISipSession;Landroid/net/sip/SipProfile;Ljava/lang/String;)V
    ...
    invoke-static {v3, p0, v2}, Lcom/android/server/sip/SipService;->access$900(Lcom/android/server/sip/SipService;Lcom/android/server/sip/SipService$SipSessionGroupExt;Lcom/android/server/sip/SipSessionGroup$SipSessionImpl;)Z
    ...
    #calls: Lcom/android/server/sip/SipService;->addPendingSession(Landroid/net/sip/ISipSession;Z)V
    invoke-static {v3, v2, v5}, Lcom/android/server/sip/SipService;->access$1000(Lcom/android/server/sip/SipService;Landroid/net/sip/ISipSession;Z)V
    ...
    invoke-static {v5}, Lcom/android/server/sip/SipService;->access$1100(Lcom/android/server/sip/SipService;)Landroid/content/Context;
...
.method public openToReceiveNotify(Landroid/net/sip/ISipSessionListener;)V
    .locals 2
    .parameter "listener"
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .prologue
    .line 830
    iput-object p1, p0, Lcom/android/server/sip/SipService$SipSessionGroupExt;->mNotifyListner:Landroid/net/sip/ISipSessionListener;
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/sip/SipSessionGroup;->openToReceiveNotify(Landroid/net/sip/ISipSessionListener;)V
...
.method public setContext(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/sip/SipSessionGroup;->setContext(Landroid/content/Context;)V
