...
# virtual methods
.method public getImageData(Lcom/android/gallery3d/data/Path;IJLcom/android/gallery3d/data/BytesBufferPool$BytesBuffer;)Z
    .locals 7
    .parameter "path"
    .parameter "type"
    .parameter "dateModifiedInSec"
    ...
    .line 63
    iget-object v5, p5, Lcom/android/gallery3d/data/BytesBufferPool$BytesBuffer;->data:[B
    ...
    iput-object v5, p5, Lcom/android/gallery3d/data/BytesBufferPool$BytesBuffer;->data:[B

    .line 69
    array-length v5, v2

    iput v5, p5, Lcom/android/gallery3d/data/BytesBufferPool$BytesBuffer;->offset:I

    .line 70
    iget v5, v3, Lcom/android/gallery3d/common/BlobCache$LookupRequest;->length:I

    iget v6, p5, Lcom/android/gallery3d/data/BytesBufferPool$BytesBuffer;->offset:I

    sub-int/2addr v5, v6

    iput v5, p5, Lcom/android/gallery3d/data/BytesBufferPool$BytesBuffer;->length:I
    :try_end_2
...
.method public putImageData(Lcom/android/gallery3d/data/Path;IJ[B)V
    .locals 7
    .parameter "path"
    .parameter "type"
    .parameter "dateModifiedInSec"
