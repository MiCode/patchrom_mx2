...
.method public getCover()Ljava/util/ArrayList;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v2, p0, Lcom/android/gallery3d/data/FaceClustering$FaceCluster;->mCoverItem:Lcom/android/gallery3d/data/MediaItem;
    ...
    .line 77
    iget-object v2, p0, Lcom/android/gallery3d/data/FaceClustering$FaceCluster;->this$0:Lcom/android/gallery3d/data/FaceClustering;

    #getter for: Lcom/android/gallery3d/data/FaceClustering;->mContext:Landroid/content/Context;
    invoke-static {v2}, Lcom/android/gallery3d/data/FaceClustering;->access$000(Lcom/android/gallery3d/data/FaceClustering;)Landroid/content/Context;

    move-result-object v2

    iget-object v3, p0, Lcom/android/gallery3d/data/FaceClustering$FaceCluster;->mCoverItem:Lcom/android/gallery3d/data/MediaItem;

    iget v4, p0, Lcom/android/gallery3d/data/FaceClustering$FaceCluster;->mCoverFaceIndex:I

    invoke-static {v2, v3, v4}, Lcom/android/gallery3d/picasasource/PicasaSource;->getFaceItem(Landroid/content/Context;Lcom/android/gallery3d/data/MediaItem;I)Lcom/android/gallery3d/data/MediaItem;
    ...
    .line 87
    .end local v0           #cover:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/gallery3d/data/MediaItem;>;"
    :goto_1
    return-object v0
