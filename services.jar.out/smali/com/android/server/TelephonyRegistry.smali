...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/TelephonyRegistry$RecordEx;,
...
.field private final mRecordsEx:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/android/server/TelephonyRegistry;->mRecordsEx:Ljava/util/ArrayList;
...
.method private removeEx(Landroid/os/IBinder;)V
    .locals 4
    .parameter "binder"

    .prologue
    .line 581
    iget-object v3, p0, Lcom/android/server/TelephonyRegistry;->mRecordsEx:Ljava/util/ArrayList;

    monitor-enter v3

    .line 582
    :try_start_0
    iget-object v2, p0, Lcom/android/server/TelephonyRegistry;->mRecordsEx:Ljava/util/ArrayList;
    ...
    check-cast v2, Lcom/android/server/TelephonyRegistry$RecordEx;

    iget-object v2, v2, Lcom/android/server/TelephonyRegistry$RecordEx;->binder:Landroid/os/IBinder;
...
.method public listenEx(Lcom/meizu/internal/telephony/IPhoneStateListenerEx;I)V
    .locals 6
    .parameter "callback"
    .parameter "events"
    ...
    .prologue
    .line 555
    iget-object v5, p0, Lcom/android/server/TelephonyRegistry;->mRecordsEx:Ljava/util/ArrayList;
    ...
    .line 557
    :try_start_0
    invoke-interface {p1}, Lcom/meizu/internal/telephony/IPhoneStateListenerEx;->asBinder()Landroid/os/IBinder;

    move-result-object v4

    invoke-direct {p0, v4}, Lcom/android/server/TelephonyRegistry;->removeEx(Landroid/os/IBinder;)V
    ...
    .line 562
    .local v3, r:Lcom/android/server/TelephonyRegistry$RecordEx;
    invoke-interface {p1}, Lcom/meizu/internal/telephony/IPhoneStateListenerEx;->asBinder()Landroid/os/IBinder;
    ...
    .line 563
    .local v0, b:Landroid/os/IBinder;
    iget-object v4, p0, Lcom/android/server/TelephonyRegistry;->mRecordsEx:Ljava/util/ArrayList;
    ...
    .end local v3           #r:Lcom/android/server/TelephonyRegistry$RecordEx;
    check-cast v3, Lcom/android/server/TelephonyRegistry$RecordEx;

    .line 566
    .restart local v3       #r:Lcom/android/server/TelephonyRegistry$RecordEx;
    iget-object v4, v3, Lcom/android/server/TelephonyRegistry$RecordEx;->binder:Landroid/os/IBinder;
    ...
    :cond_2
    :try_start_1
    new-instance v3, Lcom/android/server/TelephonyRegistry$RecordEx;

    .end local v3           #r:Lcom/android/server/TelephonyRegistry$RecordEx;
    const/4 v4, 0x0

    invoke-direct {v3, v4}, Lcom/android/server/TelephonyRegistry$RecordEx;-><init>(Lcom/android/server/TelephonyRegistry$1;)V

    .line 572
    .restart local v3       #r:Lcom/android/server/TelephonyRegistry$RecordEx;
    iput-object v0, v3, Lcom/android/server/TelephonyRegistry$RecordEx;->binder:Landroid/os/IBinder;

    .line 573
    iput-object p1, v3, Lcom/android/server/TelephonyRegistry$RecordEx;->callback:Lcom/meizu/internal/telephony/IPhoneStateListenerEx;

    .line 574
    iput p2, v3, Lcom/android/server/TelephonyRegistry$RecordEx;->events:I
...
.method public notifyPreciseCallStateChange([Lcom/meizu/internal/telephony/CallInfo;)V
    .locals 5
    ...
    .line 596
    .local v2, r:Lcom/android/server/TelephonyRegistry$RecordEx;
    iget v3, v2, Lcom/android/server/TelephonyRegistry$RecordEx;->events:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 598
    :try_start_1
    iget-object v3, v2, Lcom/android/server/TelephonyRegistry$RecordEx;->callback:Lcom/meizu/internal/telephony/IPhoneStateListenerEx;

    invoke-interface {v3, p1}, Lcom/meizu/internal/telephony/IPhoneStateListenerEx;->onPreciseCallStateChange([Lcom/meizu/internal/telephony/CallInfo;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    .local v0, ex:Landroid/os/RemoteException;
    :try_start_2
    iget-object v3, v2, Lcom/android/server/TelephonyRegistry$RecordEx;->binder:Landroid/os/IBinder;

    invoke-direct {p0, v3}, Lcom/android/server/TelephonyRegistry;->removeEx(Landroid/os/IBinder;)V
    ...
    .end local v0           #ex:Landroid/os/RemoteException;
    .end local v1           #i:I
    .end local v2           #r:Lcom/android/server/TelephonyRegistry$RecordEx;
    :catchall_0
    move-exception v3
