...
.method public constructor <init>(Lcom/android/server/BackupManagerService;Lcom/android/internal/backup/IBackupTransport;Ljava/util/ArrayList;Ljava/io/File;)V
    ...
    iput-object v0, p0, Lcom/android/server/BackupManagerService$PerformBackupTask;->mObserver:Landroid/app/backup/IBackupObserver;

    .line 1830
    iput-boolean v3, p0, Lcom/android/server/BackupManagerService$PerformBackupTask;->mIsInvokeByOuter:Z
    ...
    .line 1865
    iput-boolean v3, p0, Lcom/android/server/BackupManagerService$PerformBackupTask;->mFinished:Z
...
.method public constructor <init>(Lcom/android/server/BackupManagerService;Lcom/android/internal/backup/IBackupTransport;Ljava/util/ArrayList;Ljava/io/File;Landroid/app/backup/IBackupObserver;)V
    .locals 4
    .parameter
    .parameter "transport"
    .parameter
    ...
    .line 1837
    iput-object p5, p0, Lcom/android/server/BackupManagerService$PerformBackupTask;->mObserver:Landroid/app/backup/IBackupObserver;

    .line 1838
    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/server/BackupManagerService$PerformBackupTask;->mIsInvokeByOuter:Z
...
.method beginBackup()V
    ...
    .line 1938
    :try_start_0
    iget-object v7, p0, Lcom/android/server/BackupManagerService$PerformBackupTask;->mObserver:Landroid/app/backup/IBackupObserver;
    ...
    invoke-interface {v7, v8}, Landroid/app/backup/IBackupObserver;->backupStarting(I)V
    :try_end_0
...
.method public execute()V
    ...
    .prologue
    .line 1877
    sget-object v1, Lcom/android/server/BackupManagerService$4;->$SwitchMap$com$android$server$BackupManagerService$BackupState:[I

    iget-object v2, p0, Lcom/android/server/BackupManagerService$PerformBackupTask;->mCurrentState:Lcom/android/server/BackupManagerService$BackupState;

    invoke-virtual {v2}, Lcom/android/server/BackupManagerService$BackupState;->ordinal()I
    ...
    .line 1887
    :pswitch_2
    iget-boolean v1, p0, Lcom/android/server/BackupManagerService$PerformBackupTask;->mFinished:Z
    ...
    :cond_1
    :try_start_0
    iget-object v1, p0, Lcom/android/server/BackupManagerService$PerformBackupTask;->mObserver:Landroid/app/backup/IBackupObserver;
    ...
    iget v2, p0, Lcom/android/server/BackupManagerService$PerformBackupTask;->mStatus:I

    invoke-interface {v1, v2}, Landroid/app/backup/IBackupObserver;->backupFinished(I)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method invokeNextAgent()V
    ...
    :cond_2
    :try_start_1
    iget-object v5, p0, Lcom/android/server/BackupManagerService$PerformBackupTask;->mObserver:Landroid/app/backup/IBackupObserver;
    ...
    invoke-interface {v5, v7}, Landroid/app/backup/IBackupObserver;->onBackuping(Ljava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public isInvokeByOuter()Z
    ...
    .prologue
    .line 1870
    iget-boolean v0, p0, Lcom/android/server/BackupManagerService$PerformBackupTask;->mIsInvokeByOuter:Z
