...
.field private mDisableUmsByLock:Z
...
.field private final mExternalVolumeLabelMap:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.field private mUnmountDisk:Landroid/os/storage/DiskInfo;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 127
    iput-boolean v1, p0, Lcom/android/server/MountService;->mPendingAutoInstall:Z

    .line 134
    iput-boolean v1, p0, Lcom/android/server/MountService;->mbHdmiInsert:Z

    .line 135
    iput-boolean v1, p0, Lcom/android/server/MountService;->mDisableUmsByLock:Z
    ...
    iput-object v0, p0, Lcom/android/server/MountService;->mExternalVolumeLabelMap:Ljava/util/HashMap;

    .line 230
    const-string v0, "externalvolumeremoved"

    iput-object v0, p0, Lcom/android/server/MountService;->mExternalVolumeState:Ljava/lang/String;

    .line 231
    iput-object v3, p0, Lcom/android/server/MountService;->mUnmountDisk:Landroid/os/storage/DiskInfo;
    ...
    iput-object v0, p0, Lcom/android/server/MountService;->mDiskList:Ljava/util/ArrayList;
    ...
    .line 259
    iput-object v3, p0, Lcom/android/server/MountService;->mWindowManager:Landroid/view/IWindowManager;
    ...
    .line 1514
    :cond_1
    const-string v0, "meizu.intent.action.AUTO_INSTALL_SUCCESSFUL"

    invoke-virtual {v6, v0}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 1515
    const-string v0, "meizu.intent.action.HOME_LAUNCHED"

    invoke-virtual {v6, v0}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 1516
    const-string v0, "meizu.intent.action.SECURITY_STATE_CHANGED"
...
.method static synthetic access$1900(Lcom/android/server/MountService;)Z
    ...
    .prologue
    .line 106
    iget-boolean v0, p0, Lcom/android/server/MountService;->mDisableUmsByLock:Z
...
.method static synthetic access$1902(Lcom/android/server/MountService;Z)Z
    ...
    .prologue
    .line 106
    iput-boolean p1, p0, Lcom/android/server/MountService;->mDisableUmsByLock:Z
...
.method static synthetic access$600(Lcom/android/server/MountService;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$700(Lcom/android/server/MountService;)Z
    ...
    .prologue
    .line 106
    iget-boolean v0, p0, Lcom/android/server/MountService;->mbHdmiInsert:Z
...
.method static synthetic access$702(Lcom/android/server/MountService;Z)Z
    ...
    .prologue
    .line 106
    iput-boolean p1, p0, Lcom/android/server/MountService;->mbHdmiInsert:Z
...
.method private doMountVolume(Ljava/lang/String;)I
    ...
    :cond_0
    :goto_0
    iget-boolean v4, p0, Lcom/android/server/MountService;->mPendingAutoInstall:Z
    ...
    .line 1227
    iput-boolean v9, p0, Lcom/android/server/MountService;->mPendingAutoInstall:Z
...
.method private notifyVolumeStateChange(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    invoke-direct {p0, v4, p2}, Lcom/android/server/MountService;->sendStorageIntent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1153
    const-string v4, "externalvolumechecking"

    invoke-direct {p0, p1, v4}, Lcom/android/server/MountService;->updateExternalVolumeState(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v4, "action.external.volume.mounted"

    invoke-direct {v1, v4}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 1157
    .restart local v1       #in:Landroid/content/Intent;
    const-string v4, "externalvolumemounted"
    ...
    .end local v1           #in:Landroid/content/Intent;
    const-string v4, "action.external.volume.unmounting"

    invoke-direct {v1, v4}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 1162
    .restart local v1       #in:Landroid/content/Intent;
    const-string v4, "externalvolumeunmounting"
    ...
    .line 1167
    iget-object v4, p0, Lcom/android/server/MountService;->mDiskList:Ljava/util/ArrayList;
    ...
    iput-object v4, p0, Lcom/android/server/MountService;->mUnmountDisk:Landroid/os/storage/DiskInfo;

    .line 1170
    new-instance v1, Landroid/content/Intent;

    .end local v1           #in:Landroid/content/Intent;
    const-string v4, "action.external.volume.idle"

    invoke-direct {v1, v4}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 1171
    .restart local v1       #in:Landroid/content/Intent;
    const-string v4, "externalvolumeidle"
...
.method public getDiskInfoList()Ljava/util/List;
    ...
    const-string v4, "externalvolume listdiskinfo"
...
.method public onEvent(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    const-string v21, "VoldResponseCode.ExternalVolumeDiskInserted"
    ...
    iget-object v0, v0, Lcom/android/server/MountService;->mDiskList:Ljava/util/ArrayList;
    ...
    invoke-direct {v12, v0, v1}, Landroid/os/storage/DiskInfo;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 925
    const-string v20, "externalvolumeinserted"
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/MountService;->updateExternalVolumeState(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v21, "VoldResponseCode.ExternalVolumeDiskRemoed"
    ...
    invoke-direct {v0, v1}, Lcom/android/server/MountService;->findDiskIndex(Ljava/lang/String;)I

    move-result v19

    .line 929
    .local v19, removeIndex:I
    const/16 v20, -0x1
    ...
    .line 931
    .restart local v12       #info:Landroid/os/storage/DiskInfo;
    iget-object v0, v12, Landroid/os/storage/DiskInfo;->mDiskName:Ljava/lang/String;

    move-object/from16 v20, v0

    const-string v21, "externalvolumeremoved"
    ...
    const-string v20, "action.external.volume.removed"
    ...
    .line 939
    .restart local v19       #removeIndex:I
    const-string v20, "MountService"
    ...
    const-string v22, "info.mDiskName "
    ...
    iput-object v12, v0, Lcom/android/server/MountService;->mUnmountDisk:Landroid/os/storage/DiskInfo;
    ...
    iget-object v0, v0, Lcom/android/server/MountService;->mUnmountDisk:Landroid/os/storage/DiskInfo;
    ...
    iget-object v0, v0, Landroid/os/storage/DiskInfo;->mDiskName:Ljava/lang/String;
    ...
    invoke-virtual {v12, v0}, Landroid/os/storage/DiskInfo;->findPartition(Ljava/lang/String;)I
    ...
    const-string v21, " info.add(cooked[3]);"
    ...
    invoke-virtual {v12, v0}, Landroid/os/storage/DiskInfo;->add(Ljava/lang/String;)V
    ...
    iget-object v0, v0, Lcom/android/server/MountService;->mWindowManager:Landroid/view/IWindowManager;
    ...
    iput-object v0, v1, Lcom/android/server/MountService;->mWindowManager:Landroid/view/IWindowManager;
    ...
    .line 1051
    :try_start_1
    const-string v20, "hdmi"

    const-string v21, "hdmi insert--->"
    ...
    invoke-interface/range {v20 .. v21}, Landroid/view/IWindowManager;->disableRotationAnim(Z)V
    :try_end_1
    ...
    const-string v20, "android.intent.action.MEIZU_SPDIF_STATE_CHANGED"
    ...
    const-string v21, "android.intent.extra.MEIZU_SPDIF_STATE"
    ...
    new-instance v21, Lcom/android/server/MountService$4;

    move-object/from16 v0, v21

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/android/server/MountService$4;-><init>(Lcom/android/server/MountService;)V
...
.method public setUsbMassStorageEnabled(Z)V
    ...
    iget-object v7, p0, Lcom/android/server/MountService;->mPower:Landroid/os/PowerManager;

    invoke-virtual {v7}, Landroid/os/PowerManager;->checkLockState()I
    ...
    const-string v9, "meizu.intent.action.UMS_ENABLED"
    ...
    invoke-direct {v3, p0, v1, v0, v5}, Lcom/android/server/MountService$UmsEnableCallBack;-><init>(Lcom/android/server/MountService;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    const-string v7, "meizu.intent.action.UMS_DISABLED"
...
.method public unmountExternalVolume(Ljava/lang/String;)I
    ...
    .line 2854
    :cond_0
    iget-object v6, p0, Lcom/android/server/MountService;->mDiskList:Ljava/util/ArrayList;
    ...
    iget-object v6, v6, Landroid/os/storage/DiskInfo;->mDiskName:Ljava/lang/String;
    ...
    iget-object v1, v6, Landroid/os/storage/DiskInfo;->mDiskLabel:Ljava/lang/String;
    ...
    const-string v9, "externalvolume unmount %s%s"
    ...
    invoke-virtual {v6, v9}, Lcom/android/server/NativeDaemonConnector;->doCommand(Ljava/lang/String;)Ljava/util/ArrayList;
    :try_end_0
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_0 .. :try_end_0} :catch_0
