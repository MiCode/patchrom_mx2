...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 162
    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mSplitView:Lcom/android/internal/widget/MzActionBarContainer;
    ...
    .line 3897
    iput-boolean v2, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mMenuChecked:Z
...
.method static synthetic access$1600(Lcom/android/internal/policy/impl/PhoneWindow;)V
    ...
    .prologue
    .line 118
    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindow;->updateMenuLed()V
...
.method private checkMenu()V
    ...
    .line 3900
    iget-boolean v12, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mMenuChecked:Z
    ...
    iget v9, v12, Landroid/content/pm/ApplicationInfo;->targetSdkVersion:I
    ...
    .line 3907
    .local v8, targetPreHoneycomb:Z
    :goto_1
    const/16 v12, 0x8

    invoke-virtual {p0, v12}, Lcom/android/internal/policy/impl/PhoneWindow;->hasFeature(I)Z

    move-result v12

    if-eqz v12, :cond_1

    invoke-virtual {p0, v10}, Lcom/android/internal/policy/impl/PhoneWindow;->hasFeature(I)Z
    ...
    .line 3910
    .local v7, targetPostHoneycomb:Z
    :goto_3
    if-eqz v7, :cond_9
    ...
    .line 3911
    sget-object v12, Landroid/os/Build;->IS_MX:Ljava/lang/Boolean;
    ...
    .line 3912
    invoke-direct {p0, v11, v11}, Lcom/android/internal/policy/impl/PhoneWindow;->getPanelState(IZ)Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;
    ...
    .line 3914
    iput-boolean v11, v6, Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;->isPrepared:Z
    ...
    :try_start_0
    invoke-virtual {p0, v6, v11}, Lcom/android/internal/policy/impl/PhoneWindow;->preparePanel(Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;Landroid/view/KeyEvent;)Z
    :try_end_0
    ...
    .line 3932
    :goto_5
    invoke-virtual {p0}, Lcom/android/internal/policy/impl/PhoneWindow;->getCallbackByMeizu()Landroid/view/Window$CallbackByMeizu;

    move-result-object v3

    .line 3933
    .local v3, mzcb:Landroid/view/Window$CallbackByMeizu;
    if-eqz v3, :cond_2

    .line 3934
    invoke-interface {v3, v2}, Landroid/view/Window$CallbackByMeizu;->setMenuLedEnable(Z)V

    .line 3951
    .end local v2           #hasMenu:Z
    .end local v3           #mzcb:Landroid/view/Window$CallbackByMeizu;
    .end local v5           #prepared:Z
    .end local v6           #st:Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;
    :cond_2
    :goto_6
    iput-boolean v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mMenuChecked:Z

    goto :goto_0

    .end local v4           #noActionBar:Z
    .end local v7           #targetPostHoneycomb:Z
    .end local v8           #targetPreHoneycomb:Z
    :cond_3
    move v8, v11
    ...
    .restart local v8       #targetPreHoneycomb:Z
    :cond_4
    move v4, v11
    ...
    .restart local v4       #noActionBar:Z
    :cond_5
    move v7, v11
    ...
    .line 3918
    .restart local v5       #prepared:Z
    .restart local v6       #st:Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;
    .restart local v7       #targetPostHoneycomb:Z
    :catch_0
    move-exception v1
    ...
    const-string v12, "Prepare Panel failed"
    ...
    .restart local v2       #hasMenu:Z
    :cond_6
    iget-object v11, v6, Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;->menu:Lcom/android/internal/view/menu/MenuBuilder;

    if-eqz v11, :cond_7

    iget-object v11, v6, Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;->menu:Lcom/android/internal/view/menu/MenuBuilder;

    invoke-virtual {v11}, Lcom/android/internal/view/menu/MenuBuilder;->size()I
    ...
    .end local v6           #st:Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;
    :cond_8
    invoke-virtual {p0, v14}, Lcom/android/internal/policy/impl/PhoneWindow;->addFlags(I)V
    ...
    .line 3941
    sget-object v11, Landroid/os/Build;->IS_MX:Ljava/lang/Boolean;
    ...
    .line 3943
    .restart local v3       #mzcb:Landroid/view/Window$CallbackByMeizu;
    if-eqz v3, :cond_2

    .line 3944
    invoke-interface {v3, v10}, Landroid/view/Window$CallbackByMeizu;->setMenuLedEnable(Z)V
...
.method private installDecor()V
    ...
    iput-object v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mDecor:Lcom/android/internal/policy/impl/PhoneWindow$DecorView;
    ...
    invoke-virtual {v10, v12}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->setDescendantFocusability(I)V

    .line 3041
    iget-object v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mDecor:Lcom/android/internal/policy/impl/PhoneWindow$DecorView;

    invoke-virtual {v10, v8}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->setIsRootNamespace(Z)V

    .line 3043
    :cond_0
    iget-object v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mContentParent:Landroid/view/ViewGroup;
    ...
    invoke-virtual {p0, v10}, Lcom/android/internal/policy/impl/PhoneWindow;->generateLayout(Lcom/android/internal/policy/impl/PhoneWindow$DecorView;)Landroid/view/ViewGroup;

    move-result-object v10

    iput-object v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mContentParent:Landroid/view/ViewGroup;

    .line 3047
    iget-object v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mDecor:Lcom/android/internal/policy/impl/PhoneWindow$DecorView;

    invoke-virtual {v10}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->makeOptionalFitsSystemWindows()V
    ...
    iput-object v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mTitleView:Landroid/widget/TextView;

    .line 3050
    iget-object v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mTitleView:Landroid/widget/TextView;
    ...
    invoke-virtual {v10, v11}, Landroid/widget/FrameLayout;->setForeground(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v11, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mTitle:Ljava/lang/CharSequence;
    ...
    check-cast v10, Lcom/android/internal/widget/ActionBarView;

    iput-object v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mActionBar:Lcom/android/internal/widget/ActionBarView;

    .line 3066
    iget-object v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mActionBar:Lcom/android/internal/widget/ActionBarView;
    ...
    invoke-virtual {v10, v12}, Lcom/android/internal/widget/ActionBarView;->setWindowCallback(Landroid/view/Window$Callback;)V

    .line 3068
    iget-object v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mActionBar:Lcom/android/internal/widget/ActionBarView;

    invoke-virtual {v10}, Lcom/android/internal/widget/ActionBarView;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v10, v12}, Lcom/android/internal/widget/ActionBarView;->setWindowTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v10}, Lcom/android/internal/widget/ActionBarView;->initProgress()V
    ...
    invoke-virtual {v10}, Lcom/android/internal/widget/ActionBarView;->initIndeterminateProgress()V
    ...
    iget v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mUiOptions:I
    ...
    .line 3094
    .local v3, isNavVisible:Z
    :try_start_0
    sget-object v10, Lcom/android/internal/policy/impl/PhoneWindow$WindowManagerHolder;->sWindowManager:Landroid/view/IWindowManager;

    invoke-interface {v10}, Landroid/view/IWindowManager;->isNavigationbarVisible()Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v7, v10}, Lcom/android/internal/widget/MzActionBarContainer;->setSplitBackground(Landroid/graphics/drawable/Drawable;)V

    .line 3111
    :cond_8
    iget-object v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mActionBar:Lcom/android/internal/widget/ActionBarView;

    invoke-virtual {v10}, Lcom/android/internal/widget/ActionBarView;->getParent()Landroid/view/ViewParent;
    ...
    :cond_9
    iput-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mSplitView:Lcom/android/internal/widget/MzActionBarContainer;
    ...
    .line 3120
    .local v4, isOverLay:Z
    iget-object v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mActionBar:Lcom/android/internal/widget/ActionBarView;

    invoke-virtual {v10, v4}, Lcom/android/internal/widget/ActionBarView;->setOverlay(Z)V

    .line 3121
    iget-object v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mActionBar:Lcom/android/internal/widget/ActionBarView;

    invoke-virtual {v10, v7}, Lcom/android/internal/widget/ActionBarView;->setSplitView(Lcom/android/internal/widget/ActionBarContainer;)V

    .line 3122
    iget-object v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mActionBar:Lcom/android/internal/widget/ActionBarView;

    invoke-virtual {v10, v6}, Lcom/android/internal/widget/ActionBarView;->setSplitActionBar(Z)V

    .line 3123
    iget-object v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mActionBar:Lcom/android/internal/widget/ActionBarView;

    invoke-virtual {v10, v8}, Lcom/android/internal/widget/ActionBarView;->setSplitWhenNarrow(Z)V
    ...
    invoke-virtual {v1, v4}, Lcom/android/internal/widget/ActionBarContextView;->setOverlay(Z)V

    .line 3128
    invoke-virtual {v1, v7}, Lcom/android/internal/widget/ActionBarContextView;->setSplitView(Lcom/android/internal/widget/ActionBarContainer;)V

    .line 3129
    invoke-virtual {v1, v6}, Lcom/android/internal/widget/ActionBarContextView;->setSplitActionBar(Z)V

    .line 3130
    invoke-virtual {v1, v8}, Lcom/android/internal/widget/ActionBarContextView;->setSplitWhenNarrow(Z)V
    ...
    .end local v3           #isNavVisible:Z
    .end local v4           #isOverLay:Z
    :cond_a
    :goto_5
    iget-object v10, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mDecor:Lcom/android/internal/policy/impl/PhoneWindow$DecorView;

    new-instance v11, Lcom/android/internal/policy/impl/PhoneWindow$1;

    invoke-direct {v11, p0}, Lcom/android/internal/policy/impl/PhoneWindow$1;-><init>(Lcom/android/internal/policy/impl/PhoneWindow;)V

    invoke-virtual {v10, v11}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->post(Ljava/lang/Runnable;)Z
    ...
    .line 3095
    .restart local v3       #isNavVisible:Z
    ...
    const-string v11, "Check navigation bar failed"
...
.method private reopenMenu(Z)V
    ...
    .line 993
    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindow;->showActionBarMenu()Z
...
.method private showActionBarMenu()Z
    .locals 1
...
.method private updateMenuLed()V
    .locals 5

    .prologue
    .line 3878
    iget-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mLedManager:Landroid/app/ILedLightsServiceManager;
    ...
    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mLedManager:Landroid/app/ILedLightsServiceManager;
    ...
    .line 3892
    .local v1, mzcb:Landroid/view/Window$CallbackByMeizu;
    if-eqz v1, :cond_2

    .line 3893
    invoke-interface {v1, v0}, Landroid/view/Window$CallbackByMeizu;->setMenuLedEnable(Z)V
...
.method protected onActive()V
    ...
    .prologue
    .line 1574
    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindow;->checkMenu()V
...
.method public final onKeyDownPanel(ILandroid/view/KeyEvent;)Z
    ...
    invoke-static {v2}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->access$100(Lcom/android/internal/policy/impl/PhoneWindow$DecorView;)Landroid/view/ActionMode;
...
.method protected onKeyUp(IILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v2}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->dispatchStatusBarTap()Z
