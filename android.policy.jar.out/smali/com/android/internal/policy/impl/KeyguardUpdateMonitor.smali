...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$KeyguardStatusbarUnlockPasswordCallback;,
        Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$FindPhoneCallbacks;,
...
# static fields
.field public static final ACTION_FLYME_FINDPHONE_LOCK:Ljava/lang/String; = "com.meizu.flyme.FindPhone.Lock"

.field public static final ACTION_FLYME_FINDPHONE_UNLOCK:Ljava/lang/String; = "com.meizu.flyme.FindPhone.UnLock"
...
.field private static final MSG_FIND_PHONE_LOCK:I = 0x137

.field private static final MSG_FIND_PHONE_UNLOCK:I = 0x138
...
.field private static final MSG_STATUSBAR_UNLOCK_PASSWORD:I = 0x139
...
.field private mStatusbarChangedCallbacks:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private mTempDisableSecurity:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v4, p0, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->mTempDisableSecurity:Z

    invoke-static {}, Lcom/google/android/collect/Lists;->newArrayList()Ljava/util/ArrayList;

    move-result-object v2

    iput-object v2, p0, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->mFindPhoneCallbacks:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->mStatusbarChangedCallbacks:Ljava/util/ArrayList;
    ...
    .line 309
    const-string v2, "com.meizu.flyme.FindPhone.Lock"

    invoke-virtual {v0, v2}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 310
    const-string v2, "com.meizu.flyme.FindPhone.UnLock"
...
.method static synthetic access$1502(Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;Z)Z
    ...
    .prologue
    .line 65
    iput-boolean p1, p0, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->mTempDisableSecurity:Z
...
.method static synthetic access$500(Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;)V
    ...
    .prologue
    .line 65
    invoke-direct {p0}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->handleFindPhoneLock()V
...
.method static synthetic access$600(Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;)V
    ...
    .prologue
    .line 65
    invoke-direct {p0}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->handleFindPhoneUnlock()V
...
.method static synthetic access$700(Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;)V
    ...
    .prologue
    .line 65
    invoke-direct {p0}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->handleStatusbarUnlockPassword()V
...
.method private handleFindPhoneLock()V
    ...
    .local v0, i:I
    :goto_0
    iget-object v1, p0, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->mFindPhoneCallbacks:Ljava/util/ArrayList;
    ...
    check-cast v1, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$FindPhoneCallbacks;

    invoke-interface {v1}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$FindPhoneCallbacks;->onSecurityLock()V
...
.method private handleFindPhoneUnlock()V
    ...
    invoke-interface {v1}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$FindPhoneCallbacks;->onSecurityUnlock()V
...
.method private handleStatusbarUnlockPassword()V
    .locals 2
    ...
    .local v0, i:I
    :goto_0
    iget-object v1, p0, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->mStatusbarChangedCallbacks:Ljava/util/ArrayList;
    ...
    check-cast v1, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$KeyguardStatusbarUnlockPasswordCallback;

    invoke-interface {v1}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$KeyguardStatusbarUnlockPasswordCallback;->onPasswordStateChangedByStatusbar()V
...
# virtual methods
.method public cleanSecurityPass()V
    .locals 3
    ...
    iput-boolean v0, p0, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->mTempDisableSecurity:Z
...
.method public isSecurityTempPass()Z
    .locals 1

    .prologue
    .line 858
    iget-boolean v0, p0, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->mTempDisableSecurity:Z
...
.method public registerFindPhoneCallbacks(Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$FindPhoneCallbacks;)V
    .locals 1
    .parameter "callback"

    .prologue
    .line 815
    iget-object v0, p0, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->mFindPhoneCallbacks:Ljava/util/ArrayList;
...
.method public registerStatusbarChangedCallbacks(Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$KeyguardStatusbarUnlockPasswordCallback;)V
    .locals 1
    .parameter "callback"

    .prologue
    .line 842
    iget-object v0, p0, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->mStatusbarChangedCallbacks:Ljava/util/ArrayList;
...
.method public setLockPatternUtils(Lcom/android/internal/widget/LockPatternUtils;)V
    ...
    .prologue
    .line 831
    iput-object p1, p0, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
